...
other categories, representing youth and young adults, which happen not
to be present in the data set. And for the income variable, the
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{select}\NormalTok{(}\KeywordTok{filter}\NormalTok{(gm, country }\OperatorTok{==}\StringTok{ "Afghanistan"}\NormalTok{), }
...
Unit: nanoseconds
  ...
  sum(x)   958  1010  1313   1024  1048   24531   100
 sumC(x)  2233  2326 14344   2393  2463 1144084   100
 sumR(x) 36827 37133 65052  37352 39131 2473100   100
\end{verbatim}
...
the second spectrogram. Explore these parameters yourself to get a
better understanding of how these different properties impact the
