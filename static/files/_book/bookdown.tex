...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-320-1.pdf}
...
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\NormalTok{weather }\OperatorTok{%>%}
\OperatorTok{+}\StringTok{   }\KeywordTok{select}\NormalTok{(year, mean_wind_speed) }\OperatorTok{%>%}
...
\OperatorTok{+}\StringTok{   }\KeywordTok{dbplot_histogram}\NormalTok{(mean_wind_speed)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{>}\StringTok{ }\NormalTok{weather }\OperatorTok{%>%}
\OperatorTok{+}\StringTok{   }\KeywordTok{select}\NormalTok{(year, mean_wind_speed) }\OperatorTok{%>%}
\OperatorTok{+}\StringTok{   }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\DecValTok{1929} \OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(mean_wind_speed)) }\OperatorTok{%>%}
\OperatorTok{+}\StringTok{   }\KeywordTok{dbplot_histogram}\NormalTok{(mean_wind_speed)}
\end{Highlighting}
\end{Shaded}
